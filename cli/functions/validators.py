...
def validate_main_file_exists(project_path: Path, project_files: list[Path], main_file: str):
    main_file_found = any(
        file_path.name == main_file and file_path.parent == project_path for file_path in project_files
    )
