...
class TestNoHardcodedAuthHeader(TestCase):
    # AC3 from SC-2535 — runtime code may not contain "X-Auth-Token"
    # outside the enum definition, the central helper, and the CORS allowlist
    # consumed by UbiFunctions (which is not a CLI auth header).
    EXCLUDED_FILES = {
    ...
    def test_no_hardcoded_x_auth_token_in_runtime_code(self):
        # Setup
